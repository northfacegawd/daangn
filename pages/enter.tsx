    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid border-b mt-8 grid-cols-2 gap-16 w-full">
            <button
        ...
        <form className={classnames("flex flex-col mt-8")}>
          ...
          <div className="mt-1">
            ...
            {method === "phone" && (
              <div className="flex rounded-sm shadow-sm">
                ...
                <input
                  id="input"
                  className="appearance-none w-full border-gray-300 rounded-md rounded-l-none shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                  type="number"
                  required
                />
              </div>
